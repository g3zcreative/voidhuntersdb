        ...
        for (const skill of inlineSkills) {
          if (skill._status === "deleted" && skill.id) {
            ...
            await supabase.from("skills").insert({
              ...
              hit1_percent: skill.hit1_percent,
              hit1_count: skill.hit1_count,
              hit1_book_bonus: skill.hit1_book_bonus,
              hit2_percent: skill.hit2_percent,
              hit2_count: skill.hit2_count,
              hit2_book_bonus: skill.hit2_book_bonus,
              created_by: user.id,
              updated_by: user.id,
            });
