...
const columns: ColumnConfig[] = [
  ...
  { key: "icon_url", label: "Icon", storageBucket: "images" },
];

export default function AdminFactions() {
  return <AdminCrudPage tableName="factions" title="Factions" columns={columns} />;
}
